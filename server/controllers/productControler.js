...
const gateway = new braintree.BraintreeGateway({
  ...
  merchantId: process.env.SECRET_BRAINTREE_MERCHANT_ID,
  publicKey: process.env.SECRET_BRAINTREE_PUBLIC_KEY,
  privateKey: process.env.SECRET_BRAINTREE_PRIVATE_KEY,
});
